...
app.post('/contactUsFormSubmission', (req, res) => {
    ...
    var message = {
        ...
        html: `<div flex="" class="c5e-input-container a12n-template-message-body flex">  <p ng-bind-html="controller.getMessagePreview()"><p>Hello ,</p>
        <p>Received a message fom ${data.name}.</p>
        <p> Contact Details: <br/> PhoneNo: ${data.phoneNo} <br/> Email: ${data.email} </p>
        <br/>
